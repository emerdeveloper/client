...
public class ClientService {
	...
	public ClientResponse getClientInformation(ClientRequest clientRequest) throws IOException {
		...
		ResponseEntity<BasicInformationResponse> basicInformationResponse = restTemplate.exchange(
				...
				HttpMethod.GET,
				entity,
				BasicInformationResponse.class
				);
	...
	private ClientResponse createClientObject(ResponseEntity<BasicInformationResponse> basicInformationResponse, ResponseEntity<UbicationResponse> ubicationResponse) {
		...
		clientData.setLastName(basicInformationData.getCustomerSurname() + " " + basicInformationData.getCustomerSecondSurname());
	...
	public ClientResponse updateClientInformation(ClientRequest clientRequest) throws IOException {
		...
		clientRequest.getData().get(0).setFullName(clientRequest.getData().get(0).getFirstName() + " " + clientRequest.getData().get(0).getLastName());
